...
namespace GraphvizOutput {
	...
	void CDotOutputVisitor::Visit(AbstractTreeGenerator::CCompoundStatement * compoundStatement)
	{
	...
	void CDotOutputVisitor::Visit(AbstractTreeGenerator::CPrintStatement *printStatement)
	{
	...
	void CDotOutputVisitor::Visit(AbstractTreeGenerator::COperationExpression *operationExpression)
	{
	...
	void CDotOutputVisitor::Visit(AbstractTreeGenerator::CNumExpression *numExpression)
	{
	...
	void CDotOutputVisitor::Visit(AbstractTreeGenerator::CIdExpression *idExpression)
	{
		size_t current = enterNode("IdExpression");
		addSubNode(current, idExpression->GetName());
	}

	void CDotOutputVisitor::Visit(AbstractTreeGenerator::CLastExpressionList *lastExpList)
	{
	...
	void CDotOutputVisitor::Visit(AbstractTreeGenerator::CAssignStatement *assignStatement)
	{
